...
abstract class Test3{
	...
	//추상 메서드 function2를 포함하는 클래스 Test3는 추상클래스가 되어야합니다
}
...
class Sub extends Test3 {
	...
	//1) Sub를 추상클래스로 만들면 추상메서드를 포함 할 수 있다
	...
	//자료형 Sub는 상속받은 Test3의 추상메서도 function2를 반드시 구현해야 합니다(추상메서드는 미구현으로 간주)
}
public class Ex03 {
	public static void main(String[] args) {
		//실제 객체를 코드에 반영할 때는 작성자의 시점/관점에 따라 필요한 부분만 반영하게 된다
		//문법적으로는 객체 특성의 형태만 지정되어있고 구체적인 내용이 지정되지 않은 형식을 추상화라고 한다
		//추상 클래스 : 구체적인 내용이 없어 객체화 할 수 없는 클래스 추상 메서드를 포함한다
		//추상 메서드 : 함수의 형태는 지정되어있으나 내용은 없어서 호출할 수 없는 함수
