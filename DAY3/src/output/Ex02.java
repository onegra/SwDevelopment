...
public class Ex02 {
	public static void main(String[] args) {
		...
		System.out.printf("num(10) : %o\n", num);
		System.out.printf("num(10) : %x\n", num);
		...
		//실수의 서식 (c언어와 달리 double도 %1f를 사용하지 않고. %f만 사용한다)
		double db = 3.14;
		System.out.printf("%f\n", db); //기본은 소수점 이하 6자리까지 출력
		System.out.printf("%.1f\n", db); //소수점 이하 1자리까지 출력
		System.out.printf("%.3f\n", db); //소수점 이하 3자리까지 출력
		System.out.printf("%.3f\n", 3.14f); //소수점 이하 3자리까지 출력
		System.out.printf("%5.2f\n", db); //소수점 포함 전체 자릴수는 5자리 이후 소수점은 2자리까지 출력
		...
		System.out.printf("[%-10s]\n",hello); 
		System.out.printf("[%,2s]\n",hello); //자릿수를 적게 설정해도 내용을 출력된다
		System.out.println();
		
		System.out.printf("num : [%10s]\n","Sam");   
		System.out.printf("num : [%10s]\n","John");  
		System.out.printf("num : [%10s]\n","Chris"); 
		System.out.printf("num : [%10s]\n","Robert");
		System.out.println();
