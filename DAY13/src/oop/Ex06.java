...
class Test {
	...
	//생성자를 작성하지 않아도 컴파일 시 기본 생성자(매개변수를 받지않는 생성자)가 자동으로 작성된다
	//Test() {}
	...
	//생성자도 함수이므로, 오버로딩(= 이름이 같지만 매개변수가 형태가 다른 함수 중복값)이 가능하다
	Test() {
...
public class Ex06 {
	public static void main(String[] args) {
		Test ob1 = new Test(); //생성자를 아에 작성하지 않아도 기본생성자를 호출 할 수 있다
		ob1.show();		
		ob1.num = 12;
		ob1.show();
