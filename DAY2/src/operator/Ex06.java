...
public class Ex06 {
	...
	public static void main(String[] args) {
		...
		//나이가 20이상이고 성별이 홀수면 quest를 수행해야 합니다
		
		//각 조건에 boolean 변수에 담아서 처리해도 된다.
		...
		//첫번째 조건이 거짓이면 두번째 조건식은 아에 수행하지 않는다.
		...
		//or 연산, 두가지 조건 중 하나라도 참이면 전체 결과는 참이다
		for (int i =0; i < 10; i++) {      //1에서 10사이의 정수중에서
			if(i % 3 == 0 || i % 4 == 0) { //3의 배수거나, 혹은 4의 배수면
