...
public class Ex02 {
	public static void main(String[] args) {
		...
		System.out.println(name2 + "의 나이는 " + age2 + "살 입니다");
		System.out.println(name3 + "의 나이는 " + age3 + "살 입니다");
		
		//이클림스 한 줄 아래로 복사하기 : ctrl + alt + ↓
		...
		//자바의 자료형
		// 1) primitive type, 기본 자료형, 원시 자료형 (문자열은 기본자료형이 아님)
		/*
