...
public class Ex06 {
	...
	//3.()안에 있는 값은 인자이다 인자를 받기위한 매개변수를 선언한다
	//4.함수정의에서는 함수의 구체적인 실행내용을 작성해야 하므로;대신 {}를 열어준다
	//5.자바의 함수는 반환자료형의 값을 반드시 반환해야만 한다
	//  따라서, 첫줄에는 반환형 타입의 변ㅅ를 선언 및 초기화하고 마지막줄에서 return 하도록 한다
	...
	public static void main(String[] args) {
		//1) 두 정수를 전달하며 두 정수 사이의 합계를 반환하는 함수
